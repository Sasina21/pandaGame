...
public class RightEnemy {
	...
	private Random random;
		...
		public RightEnemy (int x) {
			this.x = x;
			this.y = Gdx.graphics.getHeight();
			
			position = new Vector2();
			temp = MathUtils.random(1);
					switch (temp) {
						/*case 0: position.x = LEFT_EDGE_ENERMY; 
							texture = new Texture ("snakeLeft.png");
								break;
						case 1: position.x = LEFT_EDGE_ENERMY; 
							texture = new Texture ("koalaLeft.png");
								break;
								*/
						case 0: position.x = RIGHT_EDGE_ENERMY; 
							texture = new Texture ("snakeRight.png");
								break;
						case 1: position.x = RIGHT_EDGE_ENERMY-50; 
